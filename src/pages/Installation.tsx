...
const Installation = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Installation Guide | SF DevX Console</title>
        <meta 
          name="description" 
          content="Learn how to install the SF DevX Console Chrome extension in just a few simple steps. Get started from the Chrome Web Store today." 
        />
      </Helmet>
