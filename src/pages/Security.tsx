...
const Security = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Security & Privacy | SF DevX Console</title>
        <meta 
          name="description" 
          content="Your data stays yours. SF DevX Console is built with privacy-first principles. We never collect, store, or transmit your Salesforce data." 
        />
      </Helmet>
