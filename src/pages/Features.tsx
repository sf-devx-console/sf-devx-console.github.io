...
const Features = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Features | SF DevX Console</title>
        <meta 
          name="description" 
          content="Explore all features of SF DevX Console, including enhanced LWC/Apex editors, advanced debug log viewer, SOQL query runner, and test class runner." 
        />
      </Helmet>
