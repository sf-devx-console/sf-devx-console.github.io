...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>SF DevX Console | Enhanced Salesforce Developer Console</title>
        <meta 
          name="description" 
          content="Transform your Salesforce Developer Console with powerful enhancements. Code faster, debug smarter, and test better with our feature-rich Chrome extension." 
        />
      </Helmet>
