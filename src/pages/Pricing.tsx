...
const Pricing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Pricing (It's Free!) | SF DevX Console</title>
        <meta 
          name="description" 
          content="SF DevX Console is completely free, forever. Get all features, including advanced editors and debugging tools, at no cost." 
        />
      </Helmet>
